"""iTransformer with a learned low-rank cross-variate attention bottleneck."""
...
class Model(nn.Module):
    """Latent iTransformer for scalable multivariate forecasting.

    For high-dimensional inputs, each encoder layer compresses all variate
    tokens into a small latent set and broadcasts global information back. For
    small inputs, exact iTransformer attention is used automatically.
    """
