...
INPUT_FILE = "./dataset/electricity/electricity.csv"
OUTPUT_FILE = "./dataset/electricity/electricity_v4.csv"

TARGET = "OT"

# ECL original:
# date + 320 variables + OT
#
...
# ECL has 321 total variables including OT.
# Therefore there are 320 candidate input variables.
#
# We use all candidate variables so that the
# diversity-aware stage has access to the complete
# ECL variable set.
CANDIDATE_SIZE = 320

# ECL benchmark data is hourly.
#
# 1   = 1 hour
# 2   = 2 hours
# 3   = 3 hours
...
class DiversityAwareTemporalSelector:
    ...
    def _build_signature(self, x):
        ...
        for lag in [1, 2, 6, 12, 24, 48, 72, 168]:
